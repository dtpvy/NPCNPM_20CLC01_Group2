...
export default function SellerInfor() {
	...
	return (
		<div className="grid grid-cols-[1.5fr_1fr_1fr_1fr] gap-4 bg-white p-4">
			<div className="bg-indigo-700 py-4 text-white flex flex-col justify-center gap-2 items-center rounded-md hover:scale-[1.025] duration-300">
			...
			<div className="flex flex-col gap-3">
				...
				<p className="">
					...
					Đang theo dõi: <span className="text-orange-700"> {data.following}</span>
				</p>
				<p className="">
					<i className="mr-2 fa fa-commenting-o"></i>
					Tỉ lệ phản hồi chat: <span className="text-orange-700"> {data.replyPercent}</span>
				</p>
			</div>
			<div className="flex flex-col gap-3">
				<p className="">
					<i className="mr-2 fa fa-window-close-o"></i>
					Tỉ lệ shop hủy đơn: <span className="text-orange-700"> {data.cancelPercent}</span>
				</p>
				<p className="">
